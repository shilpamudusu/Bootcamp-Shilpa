...
export default function GeneEssentialityMap({ initialEnsemblId = "ENSG00000012048" }: GeneEssentialityMapProps) {
        ...
        <>
          <div className="flex flex-col justify-center mt-4">
            <div className="flex justify-center mt-4 border w-fit p-2 border-gray-500 rounded-xl">
              ...
              <div className="flex items-center space-x-4 ">
                <div className="w-4 h-4 bg-red-400 rounded-full ml-4 "></div>
